class Tracekit < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/Tracekit-Dev/cli/releases/download/v2.0.6/tracekit-darwin-arm64"
      sha256 "cbe3ec1698099e5cf36d2f10747ffb99c9f55cba56ecf6418aff90ffae37fa40"
    else
      url "https://github.com/Tracekit-Dev/cli/releases/download/v2.0.6/tracekit-darwin-amd64"
  ...
  on_linux do
    if Hardware::CPU.arm?
      url "https://github.com/Tracekit-Dev/cli/releases/download/v2.0.6/tracekit-linux-arm64"
      sha256 "7760946a413d7a380fc3bda4abf658874b2492694865f8092dd75f21cae25d0e"
    else
      url "https://github.com/Tracekit-Dev/cli/releases/download/v2.0.6/tracekit-linux-amd64"
