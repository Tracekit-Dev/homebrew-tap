class Tracekit < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/Tracekit-Dev/cli/releases/download/v2.0.7/tracekit-darwin-arm64"
      sha256 "8d64d1fcd7f51caf7bdebbb2481007c23582e72aafab683b251418203dfec80f"
    else
      url "https://github.com/Tracekit-Dev/cli/releases/download/v2.0.7/tracekit-darwin-amd64"
  ...
  on_linux do
    if Hardware::CPU.arm?
      url "https://github.com/Tracekit-Dev/cli/releases/download/v2.0.7/tracekit-linux-arm64"
      sha256 "7760946a413d7a380fc3bda4abf658874b2492694865f8092dd75f21cae25d0e"
    else
      url "https://github.com/Tracekit-Dev/cli/releases/download/v2.0.7/tracekit-linux-amd64"
