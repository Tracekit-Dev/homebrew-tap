class Tracekit < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/Tracekit-Dev/cli/releases/download/v1.0.4/tracekit-darwin-arm64"
      sha256 "fa5b10fa2ccfca58ad2210f06a3a0fc0efda2e5c5881bc00b4788fb9af3465a0"
    else
      url "https://github.com/Tracekit-Dev/cli/releases/download/v1.0.4/tracekit-darwin-amd64"
  ...
  on_linux do
    if Hardware::CPU.arm?
      url "https://github.com/Tracekit-Dev/cli/releases/download/v1.0.4/tracekit-linux-arm64"
      sha256 "7760946a413d7a380fc3bda4abf658874b2492694865f8092dd75f21cae25d0e"
    else
      url "https://github.com/Tracekit-Dev/cli/releases/download/v1.0.4/tracekit-linux-amd64"
